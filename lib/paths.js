...
exports.mixin = function(_){
    ...
    _.extend(paths.prototype, lib);

    paths.prototype.root = function(path, setFlag){
    ...
    paths.prototype.make = function(options){
        return(new paths(options));
    };

    paths.prototype.mixin = function mixin(root, options){
        root = root || {};

        root.paths = new paths(options);
