...
test("to_number", function(){
    eq(_.toNumber('not a number'), null);
    eq(_.toNumber(0), 0);
    eq(_.toNumber(-2), -2);
    eq(_.toNumber('-2'), -2);
    eq(_.toNumber(2.3446), 2.3446);
    eq(_.toNumber('2.3446'), 2.3446);
    eq(_.toNumber('-2.3446'), -2.3446);
    eq(_.toNumber('0'), 0);
    eq(_.toNumber('0.0'), 0);
    eq(_.toNumber('0.1'), 0.1);
    eq(_.toNumber(('0.1'), 1), 0.1);
    eq(_.toNumber(('  0.1 '), 1), 0.1);
    eq(_.toNumber('0000'), 0);
    eq(_.toNumber('2.345'), 2.345);
    eq(_.toNumber('2.345', NaN), 2);
    eq(_.toNumber('2.345', 2), 2.35);
    eq(_.toNumber('2.344', 2), 2.34);
    eq(_.toNumber('2', 2), 2.00);
    eq(_.toNumber(2, 2), 2.00);
    eq(_.toNumber(''), null);
    eq(_.toNumber(null), null);
    eq(_.toNumber(undefined), null);
    eq(_.toNumber(), null);
    eq(_.toNumber("1b2c3"), null);
    eq(_.toNumber("a1b2c3"), null);
});
