...
exports.mixin = function(_){
    ...
    html.strip = function(str){
        ...
        html.parser(str, {
            start: function( tag, attrs, unary ) { text += " "; },
            end: function( tag ) { },
            chars: function( chars ) {
                text += html.escape(chars);
            },
    ...
    html.style = function(html, elements){
        ...
        function runStyle(str){
            ...
            function start(tag, attrs) {
                ...
                _.each(attrs, function(attr, i){
                    if(attr.name.toLowerCase() === 'style' && elements[tag]){ attr.value += elements[tag]; }
            ...
            function chars(text) { result += html.escape(text); }
