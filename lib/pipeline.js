...
exports.mixin = function(_){
    ...
    pipeline.prototype.before = function(stageAfter, stageBefore){
        ...
        if(!before && !after){
            ...
            if(before.next === null && after.prev === null){
                ...
                throw(_.error("bad_stage_location", 
    ...
    pipeline.prototype.order = function(){
        ...
        if(order.length !== this.nodes.length){
            throw(_.error("dangling_step", "There are more pipeline nodes pending than there are conected. nodes: " +  _.s(_.pluck(this.nodes, "name")) + " connected: " + _.s(order))); 
        }
