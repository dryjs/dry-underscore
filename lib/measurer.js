...
var measurer = function(f, parent){
    ...
    f.measure = function(categoryName, measurementName){
        ...
        if(measurementName !== undefined || _.isObject(categoryName)){ 
            ...
            return({
                ...
                displayLast: _.bind(self.measureDisplayLast, self),
            });
        }else{
            return({
                ...
                displayLast: _.bind(self.measureDisplayLast, self, categoryName),
            });
        }
    };
    ...
    f.measureDisplayLast = function(categoryName, writer){
        var measurements = this.measureLast(categoryName);
