...
test("inspect prototype", function(){
    function obj(){ this.this_property = "123"; }
    obj.prototype.prototype_property = "abc";

    eq(_.inspect(new obj()), "{ this_property: '123', prototype_property: 'abc' }");
});
